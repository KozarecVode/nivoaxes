...
var Axis = function Axis(_ref2) {
  ...
  if (animate !== true) {
    return React.createElement("g", {
      ...
      return React.createElement(renderTick, _objectSpread$1(_objectSpread$1({
        tickIndex: tickIndex,
        format: formatValue,
        rotate: tickRotation,
        textBaseline: textBaseline,
    ...
    return React.createElement("g", {
      ...
      return React.createElement(Fragment, null, interpolatedStyles.map(function (_ref3, tickIndex) {
        var style = _ref3.style,
            tick = _ref3.data;
        return React.createElement(renderTick, _objectSpread$1(_objectSpread$1(_objectSpread$1({
          tickIndex: tickIndex,
          format: formatValue,
          textBaseline: textBaseline,
          textAnchor: textAlign
