(function (global, factory) {
    ...
    var appendTickValues = function appendTickValues(scale) {
      var ticks = scale.ticks();
      if (ticks && ticks.length > 2) {
        var tickStep = ticks[1] - ticks[0];
        var firstTick = ticks[0] - tickStep;
        var lastTick = ticks[ticks.length - 1] + tickStep;
    ...
    var Axis = function Axis(_ref2) {
      ...
      if (animate !== true) {
        return React__default.createElement("g", {
          ...
          return React__default.createElement(renderTick, _objectSpread$1(_objectSpread$1({
            tickIndex: tickIndex,
            format: formatValue,
            rotate: tickRotation,
            textBaseline: textBaseline,
        ...
        return React__default.createElement("g", {
          ...
          return React__default.createElement(React.Fragment, null, interpolatedStyles.map(function (_ref3, tickIndex) {
            var style = _ref3.style,
                tick = _ref3.data;
            return React__default.createElement(renderTick, _objectSpread$1(_objectSpread$1(_objectSpread$1({
              tickIndex: tickIndex,
              format: formatValue,
              textBaseline: textBaseline,
              textAnchor: textAlign
    ...
    var renderAxesToCanvas = function renderAxesToCanvas(ctx, _ref2) {
      ...
      positions$1.forEach(function (position) {
        ...
        renderAxisToCanvas(ctx, _objectSpread$2(_objectSpread$2({}, axis), {}, {
          axis: isXAxis ? 'x' : 'y',
          x: position === 'right' ? width : 0,
          y: position === 'bottom' ? height : 0,
          scale: scale,
